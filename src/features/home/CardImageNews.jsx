  ...
  return (
    <div className="card  w-full bg-base-100 shadow-xl">
      <div className=" relative">
        ...
        <div className=" absolute right-0   bottom-[-1.5rem] bg-dark-blue w-15 lg:w-20 max-lg:px-4 flex flex-col justify-center items-center text-white py-2 rounded-xl">
